...
export default function ProductDetailHero({
  ...
  return (
    <section className="detail-hero detail-hero--product relative min-h-[700px] overflow-hidden bg-[#071A2A] text-white lg:min-h-[740px]">
      ...
      <div className="site-container relative flex min-h-[700px] flex-col pb-8 pt-28 lg:min-h-[740px] lg:pb-10 lg:pt-32">
        ...
        <div className="my-auto max-w-4xl py-12">
          ...
          <h1 className="site-page-title mt-5 max-w-4xl text-white">
