    ...
    <div className="detail-page">
      ...
      <section className="relative py-24 overflow-hidden">
        <div className="absolute inset-0 z-0">
          ...
          <div className="absolute inset-0 bg-gradient-to-t from-[#7454A2]/10 to-transparent"></div>
        </div>
        <div className="relative z-10 max-w-3xl mx-auto px-4 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link
              href="/contact"
              className="inline-flex items-center justify-center px-8 py-4 bg-gradient-to-r from-[#5a3a8a] to-[#7454A2] text-white font-bold rounded-lg hover:shadow-[0_0_20px_rgba(116,84,162,0.4)] hover:-translate-y-1 transition-all"
            >
              Request a Demo
            </Link>
            <a
