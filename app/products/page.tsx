...
const products = [
  ...
  },
  {
    icon: Zap,
    name: "Pharmeta",
    tagline: "Pharma Commercial Analytics Suite",
    href: "/products/pharmeta",
    externalHref: "https://pharmeta.io",
    description:
      "Purpose-built analytics suite for pharmaceutical commercial teams. Pharmeta integrates sales performance, market access data, physician targeting, and patient journey analytics into a single, compliant platform — eliminating the need for multiple point solutions.",
    capabilities: [
      "Sales force performance analytics",
      "Market access & payer intelligence",
      "Physician targeting & segmentation",
      "Patient journey analytics",
      "KPI benchmarking & forecasting",
    ],
    deploymentOptions: ["Cloud (AWS)", "Validated GxP environment"],
